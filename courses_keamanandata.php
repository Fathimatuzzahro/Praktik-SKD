    ...
    <section class="popular-course-area section-gap">
        <div class="container-fluid">
            <div class="row justify-content-center section-title">
                <div class="col-lg-12">
                    <h2>
                        Popular Courses Sistem Keamanan Data <br /> Available Right Now
                    </h2>
                    <p>
                        ...
                        Pada Course Sistem Keamanan Data ada beberapa macam algoritma seperti caesar cipher, vigenere cipher, AES, RSA, MD5 , SHA dan masih banyak lagi
                    </p>
                </div>
            </div>
            <div class="owl-carousel popuar-course-carusel">
                <div class="single-popular-course">
                    ...
                    <div class="details">
                        <div class="d-flex justify-content-between mb-20">
                            <p class="name">Algoritma</p>
                        </div>
                        <a href="/UTS_SKD/CaesarCipher/index.php">
                            <h4>Caesar Cipher</h4>
                        </a>
                    </div>
                </div>
                ...
                <div class="single-popular-course">
                    ...
                    <div class="details">
                        ...
                        <a href="/UTS_SKD/VigenereCipher/index.php">
                ...
                <div class="single-popular-course">
                    ...
                    <div class="details">
                        ...
                        <a href="/UTS_SKD/AES/cobaaes.php">
                            <h4>AES</h4>
                        </a>
                    </div>
                </div>
            ...
            <div class="row align-items-end">
                <div class="col-lg-5">
                    <div class="section-title text-left text-white">
                        <h2 class="text-white">
                            Let's Get <br> Registration Course Sistem Keamanan Data
                        </h2>
                        <p>
                            Ayo bergabung dengan Course Sistem Keamanan Data Alexandria Computing School , kembangkan bakat dan minat mu di bidang IT .
                        </p>
                    </div>
                </div>
                <?php require 'functions_regist_keamanandata.php';
                ...
                if (isset($_POST["submit"])) {
                    ...
                    if (tambah($_POST) > 0) {
                        echo "
                        <script>
                            alert('Registrasi Course Sistem Keamanan Data BERHASIL');
                            document.location.href = '/UTS_SKD/courses_keamanandata.php';
                        </script>";
                    } else {
                        echo "
                        <script>
                            alert('Registrasi Course Sistem Keamanan Data  GAGAL');
                            document.location.href = '/UTS_SKD/courses_keamanandata.php';
                        </script>";
                    }
                }
                ...
                <div class="offset-lg-3 col-lg-4 col-md-6">
                    <div class="course-form-section">
                        <h3 class="text-white">Registration for Course Sistem Keamanan Data</h3>
