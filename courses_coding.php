    ...
    <section class="registration-area">
        <div class="container">
            <div class="row align-items-end">
                ...
                <?php require 'functions_regist_coding.php';
                ...
                if (isset($_POST["submit"])) {
                    ...
                    if (tambah($_POST) > 0) {
                        echo "
                        <script>
                            alert('Registrasi Course Coding BERHASIL');
                            document.location.href = '/UTS_SKD/courses_coding.php';
                        </script>";
                    } else {
                        echo "
                        <script>
                            alert('Registrasi Course Coding GAGAL');
                            document.location.href = '/UTS_SKD/courses_coding.php';
                        </script>";
                    }
                }
