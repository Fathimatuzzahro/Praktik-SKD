        ...
        <div class="container-fluid">
            <div class="row justify-content-center section-title">
                <div class="col-lg-12">
                    ...
                    <br>
                    <p>
                        Nah, di bab ini kami akan membahas pengertian serta perbedaan antara web designer, web developer, dan webmaster. Langsung saja simak uraiannya berikut ini.</p>
                    <br>
                    ...
                    <br>
                    <p>
                        Beberapa tugas seorang web developer adalah membuat database dan mengatur server. Hasil pekerjaannya memang tidak eksplisit terlihat di halaman website, karena coding yang dibuat di web server dan database. </p>
                    <br>
            ...
            <div class="row align-items-end">
                <div class="col-lg-5">
                    <div class="section-title text-left text-white">
                        ...
                        <p>
                            Ayo bergabung dengan Couse Design Web Alexandria Computing School , kembangkan bakat dan minat mu di bidang IT .
                        </p>
                    </div>
                </div>
