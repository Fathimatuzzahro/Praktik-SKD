...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <script>
            var firebaseConfig = {
            apiKey: "AIzaSyDqDGnwRRaMDIeXk8tf-mR4YR0s6fgSmeE",
            authDomain: "larvel-otp.firebaseapp.com",
            projectId: "larvel-otp",
            storageBucket: "larvel-otp.appspot.com",
            messagingSenderId: "638717332148",
            appId: "1:638717332148:web:3f0e356e92b226bbd6e5e1"
            };
