...
$email_pengirim = 'zahro010323@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'Fathimatuzzahro'; // Isikan dengan nama pengirim
//$email_penerima = $_POST['email_penerima']; // Ambil email penerima dari inputan form
$user_email = $_POST['user_email']; // Ambil email penerima dari inputan form
...
$mail->Password = 'louxpkoyofhpkfwy'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
